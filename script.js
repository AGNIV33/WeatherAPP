...
// API Key
const apiKey = 'be2b81c3781742da14d00405c1f8194f';
...
function updateFlag(countryCode) {
    ...
    countryFlagImg.src = `https://flagsapi.com/${countryCode}/shiny/32.png`;
...
async function updateWeatherInfo(city) {
    ...
    const {
        name: country,
        sys: { country: countryCode }, // Destructure country code
        main: { temp, humidity },
        weather: [{ id, main }],
        wind: { speed },
    } = weatherData;
    ...
    updateFlag(countryCode); // Pass countryCode to the function
...
function updateForecastsItems(weatherData) {
    ...
    const forecastItem = `
        <div class="forecast-item">
            <h5 class="forecast-item-date regualar-txt">${dateResult}</h5>
